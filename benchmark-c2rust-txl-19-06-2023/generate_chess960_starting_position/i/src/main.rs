    ...
    unsafe {
        while i < 8 {
            if rank[i as usize] as i32 == 'K' as i32 {
                printf(b"%lc\0" as *const u8 as *const i8, 9812);
            } else if rank[i as usize] as i32 == 'Q' as i32 {
                printf(b"%lc\0" as *const u8 as *const i8, 9813);
            } else if rank[i as usize] as i32 == 'R' as i32 {
                printf(b"%lc\0" as *const u8 as *const i8, 9814);
            } else if rank[i as usize] as i32 == 'B' as i32 {
                printf(b"%lc\0" as *const u8 as *const i8, 9815);
            }
            if rank[i as usize] as i32 == 'N' as i32 {
                printf(b"%lc\0" as *const u8 as *const i8, 9816);
            }
            i += 1;
            i;
        }
