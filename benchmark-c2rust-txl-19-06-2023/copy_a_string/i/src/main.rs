...
fn main_0() -> i32 {
    unsafe {
        ...
        printf(b" src: %s\n\0" as *const u8 as *const i8, src.as_mut_ptr());
        printf(b"dst1: %s\n\0" as *const u8 as *const i8, dst1.as_mut_ptr());
        printf(b"dst2: %s\n\0" as *const u8 as *const i8, dst2.as_mut_ptr());
        printf(b"dst3: %s\n\0" as *const u8 as *const i8, dst3);
        printf(b" ref: %s\n\0" as *const u8 as *const i8, ref_0);
