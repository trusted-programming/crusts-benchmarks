...
fn main_0() -> i32 {
    unsafe {
        ...
        printf(b"Filtered even:\0" as *const u8 as *const i8);
        i = 0;
        while i < len {
            printf(b" %d\0" as *const u8 as *const i8, *even.offset(i as isize));
            i += 1;
            i;
        }
        ...
        printf(b"In-place filtered not multiple of 3:\0" as *const u8 as *const i8);
        i = 0;
        while i < len {
            printf(b" %d\0" as *const u8 as *const i8, in_0[i as usize]);
            i += 1;
            i;
        }
        printf(b"\n\0" as *const u8 as *const i8);
