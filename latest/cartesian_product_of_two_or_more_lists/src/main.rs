...
// SAFETY: machine generated unsafe code
    unsafe {
        ...
        while !token.is_null() {
            ...
            *setLengths.offset(counter as isize) = setLength + 1_i32;
            let fresh2 = &mut (*sets.offset(counter as isize));
            *fresh2 =
                malloc(((1 + setLength) as u64).wrapping_mul(::core::mem::size_of::<i32>() as u64)).cast::<i32>();
            k = 0_i32;
            start = 0_i32;
            l = 0_i32;
            while i32::from(*holder.offset(l as isize)) != 0_i32 {
                if i32::from(*holder.offset((l + 1i32) as isize)) == ' ' as i32
                    || i32::from(*holder.offset((l + 1i32) as isize)) == 0_i32
                {
                    holderToken = malloc(
