...
// SAFETY: machine generated unsafe code
    unsafe {
        let mut c: *mut i32 = calloc(
            (limit.wrapping_add(1i32)) as u64,
...
// SAFETY: machine generated unsafe code
    unsafe {
        ...
        while i < primeCount {
            ...
            if findPeriod(prime) == prime.wrapping_sub(1) {
        ...
        *totals.offset((numberCount.wrapping_sub(1i32)) as isize) = count;
