...
// SAFETY: machine generated unsafe code
    unsafe {
        ...
        if len == strlen(result) {
            ...
            __assert_fail(
                (b"len == strlen(result)\0" as *const u8).cast::<i8>(),
        ...
        memset(
            counts.as_mut_ptr().cast::<libc::c_void>(),
            '\0' as i32,
        ...
        if fmax > 0 && fmax <= len {
            ...
            __assert_fail(
                (b"fmax > 0 && fmax <= len\0" as *const u8).cast::<i8>(),
                (b"main.c\0" as *const u8).cast::<i8>(),
                29,
                (*::core::mem::transmute::<&[u8; 40], &[i8; 40]>(
                    b"void best_shuffle(const char *, char *)\0",
        ...
        let mut ndx1: *mut u64 =
            malloc(len.wrapping_mul(::core::mem::size_of::<u64>() as u64)).cast::<u64>();
        if ndx1.is_null() {
            exit(1);
        }
        let mut ch: u64 = 0;
        let mut i_0: u64 = 0;
        while ch < (127_i32 * 2_i32 + 1i32) as u64 {
        ...
        if grp > 0 && grp <= len {
            ...
            __assert_fail(
                (b"grp > 0 && grp <= len\0" as *const u8).cast::<i8>(),
                (b"main.c\0" as *const u8).cast::<i8>(),
                58,
                (*::core::mem::transmute::<&[u8; 40], &[i8; 40]>(
                    b"void best_shuffle(const char *, char *)\0",
        ...
        if lng > 0 && lng <= len {
            ...
            __assert_fail(
                (b"lng > 0 && lng <= len\0" as *const u8).cast::<i8>(),
                (b"main.c\0" as *const u8).cast::<i8>(),
                62,
                (*::core::mem::transmute::<&[u8; 40], &[i8; 40]>(
                    b"void best_shuffle(const char *, char *)\0",
        ...
        *result.offset(len as isize) = '\0' as i8;
        ...
        free(ndx1.cast::<libc::c_void>());
        free(ndx2.cast::<libc::c_void>());
    }
}
...
// SAFETY: machine generated unsafe code
    unsafe {
        ...
        if len == strlen(txt2) {
            ...
            __assert_fail(
                (b"len == strlen(txt2)\0" as *const u8).cast::<i8>(),
                (b"main.c\0" as *const u8).cast::<i8>(),
                85,
...
fn main_0() -> i32 {
    let mut data: [*const i8; 9] = [
        (b"abracadabra\0" as *const u8).cast::<i8>(),
        (b"seesaw\0" as *const u8).cast::<i8>(),
        (b"elk\0" as *const u8).cast::<i8>(),
        (b"grrrrrr\0" as *const u8).cast::<i8>(),
        (b"up\0" as *const u8).cast::<i8>(),
        (b"a\0" as *const u8).cast::<i8>(),
        (b"aabbbbaa\0" as *const u8).cast::<i8>(),
        (b"\0" as *const u8).cast::<i8>(),
        (b"xxxxx\0" as *const u8).cast::<i8>(),
    ];
...
// SAFETY: machine generated unsafe code
    unsafe {
        while i < data_len {
            ...
            memset(
                shuf.as_mut_ptr().cast::<libc::c_void>(),
                0xff,
