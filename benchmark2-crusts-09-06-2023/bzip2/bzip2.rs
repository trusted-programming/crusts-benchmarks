extern "C" {
    ...
    fn BZ2_bzWriteOpen(
        bzerror: *mut std::os::raw::c_int,
        f: *mut FILE,
        blockSize100k_0: std::os::raw::c_int,
        verbosity_0: std::os::raw::c_int,
        workFactor_0: std::os::raw::c_int,
    ) -> *mut std::os::raw::c_void;
    #[no_mangle]
    fn BZ2_bzWrite(
        bzerror: *mut std::os::raw::c_int,
...
#[inline]
#[linkage = "external"]
pub extern "C" fn isspace(mut _c: std::os::raw::c_int) -> std::os::raw::c_int {
...
extern "C" fn uInt64_from_UInt32s(mut n: *mut UInt64, mut lo32: UInt32, mut hi32: UInt32) {
    unsafe {
...
extern "C" fn uInt64_to_double(mut n: *mut UInt64) -> std::os::raw::c_double {
    unsafe {
        let mut i: Int32 = 0;
...
extern "C" fn uInt64_isZero(mut n: *mut UInt64) -> Bool {
    unsafe {
        let mut i: Int32 = 0;
        i = 0 as std::os::raw::c_int;
        while i < 8 as std::os::raw::c_int {
...
extern "C" fn uInt64_qrm10(mut n: *mut UInt64) -> Int32 {
    unsafe {
...
extern "C" fn uInt64_toAscii(mut outbuf: *mut std::os::raw::c_char, mut n: *mut UInt64) {
    unsafe {
        let mut i: Int32 = 0;
        let mut q: Int32 = 0;
...
extern "C" fn myfeof(mut f: *mut FILE) -> Bool {
    unsafe {
...
extern "C" fn uncompressStream(mut zStream: *mut FILE, mut stream: *mut FILE) -> Bool {
    unsafe {
        let mut current_block: u64;
        let mut bzf: *mut std::os::raw::c_void = 0 as *mut std::os::raw::c_void;
        let mut bzerr: Int32 = 0;
...
extern "C" fn testStream(mut zStream: *mut FILE) -> Bool {
    unsafe {
        let mut current_block: u64;
        let mut bzf: *mut std::os::raw::c_void = 0 as *mut std::os::raw::c_void;
        let mut bzerr: Int32 = 0;
...
extern "C" fn setExit(mut v: Int32) {
    unsafe {
        if v > exitValue {
            exitValue = v
        };
...
extern "C" fn cleanUpAndFail(mut ec: Int32) -> ! {
    ...
    unsafe {
        ...
        {
            fprintf (__stderrp, b"%s: WARNING: some files have not been processed:\n%s:    %d specified on command line, %d not processed yet.\n\n\x00" as * const u8 as * const std :: os :: raw :: c_char, progName, progName, numFileNames, numFileNames -
              numFilesProcessed);
        }
    }
    setExit(ec);
...
extern "C" fn panic(mut s: *const Char) -> ! {
    unsafe {
        fprintf (__stderrp, b"\n%s: PANIC -- internal consistency error:\n\t%s\n\tThis is a BUG.  Please report it to:\n\tbzip2-devel@sourceware.org\n\x00" as * const u8 as * const std :: os :: raw :: c_char, progName, s);
        showFileNames();
...
extern "C" fn compressedStreamEOF() -> ! {
    unsafe {
        if noisy != 0 {
            fprintf (__stderrp, b"\n%s: Compressed file ends unexpectedly;\n\tperhaps it is corrupted?  *Possible* reason follows.\n\x00" as * const u8 as * const std :: os :: raw :: c_char, progName);
            perror(progName);
            showFileNames();
            cadvise();
        }
...
extern "C" fn mySignalCatcher(mut n: IntNative) {
    unsafe {
        fprintf(
            __stderrp,
...
extern "C" fn mySIGSEGVorSIGBUScatcher(mut n: IntNative) {
    unsafe {
...
extern "C" fn pad(mut s: *mut Char) {
    unsafe {
        let mut i: Int32 = 0;
...
extern "C" fn copyFileName(mut to: *mut Char, mut from: *mut Char) {
    unsafe {
        if strlen(from)
            > (1034 as std::os::raw::c_int - 10 as std::os::raw::c_int) as std::os::raw::c_ulong
        {
            fprintf (__stderrp, b"bzip2: file name\n`%s\'\nis suspiciously (more than %d chars) long.\nTry using a reasonable file name instead.  Sorry! :-)\n\x00" as * const u8 as * const std :: os :: raw :: c_char, from, 1034 as std :: os :: raw :: c_int
...
extern "C" fn fileExists(mut name: *mut Char) -> Bool {
    unsafe {
...
extern "C" fn fopen_output_safely(
    mut name: *mut Char,
...
extern "C" fn notAStandardFile(mut name: *mut Char) -> Bool {
    unsafe {
...
extern "C" fn countHardLinks(mut name: *mut Char) -> Int32 {
    unsafe {
        let mut i: IntNative = 0;
        let mut statBuf: stat = stat {
            st_dev: 0,
...
extern "C" fn saveInputFileMetaInfo(mut srcName: *mut Char) {
    unsafe {
        let mut retVal: IntNative = 0;
...
extern "C" fn applySavedTimeInfoToOutputFile(mut dstName: *mut Char) {
    unsafe {
        let mut retVal: IntNative = 0;
...
extern "C" fn applySavedFileAttrToOutputFile(mut fd: IntNative) {
    let mut retVal: IntNative = 0;
    unsafe {
...
extern "C" fn hasSuffix(mut s: *mut Char, mut suffix: *const Char) -> Bool {
    unsafe {
...
extern "C" fn compress(mut name: *mut Char) {
    unsafe {
...
extern "C" fn uncompress(mut name: *mut Char) {
    unsafe {
        let mut current_block: u64;
        let mut inStr: *mut FILE = 0 as *mut FILE;
        let mut outStr: *mut FILE = 0 as *mut FILE;
...
extern "C" fn testf(mut name: *mut Char) {
    unsafe {
        let mut inStr: *mut FILE = 0 as *mut FILE;
...
extern "C" fn usage(mut fullProgName: *mut Char) {
    unsafe {
        fprintf (__stderrp,
b"bzip2, a block-sorting file compressor.  Version %s.\n\n   usage: %s [flags and input files in any order]\n\n   -h --help           print this message\n   -d --decompress     force decompression\n   -z --compress       force compression\n   -k --keep           keep (don\'t delete) input files\n   -f --force          overwrite existing output files\n   -t --test           test compressed file integrity\n   -c --stdout         output to standard out\n   -q --quiet          suppress noncritical error messages\n   -v --verbose        be verbose (a 2nd -v gives more)\n   -L --license        display software version & license\n   -V --version        display software version & license\n   -s --small          use less memory (at most 2500k)\n   -1 .. -9            set block size to 100k .. 900k\n   --fast              alias for -1\n   --best              alias for -9\n\n   If invoked as `bzip2\', default action is to compress.\n              as `bunzip2\',  default action is to decompress.\n              as `bzcat\', default action is to decompress to stdout.\n\n   If no file names are given, bzip2 compresses or decompresses\n   from standard input to standard output.  You can combine\n   short flags, so `-v -4\' means the same as -v4 or -4v, &c.\n\n\x00"
         as * const u8 as * const std :: os :: raw :: c_char, BZ2_bzlibVersion (), fullProgName);
    }
}

extern "C" fn redundant(mut flag: *mut Char) {
    unsafe {
        fprintf(
            __stderrp,
...
extern "C" fn myMalloc(mut n: Int32) -> *mut std::os::raw::c_void {
    unsafe {
...
extern "C" fn snocString(mut root: *mut Cell, mut name: *mut Char) -> *mut Cell {
    unsafe {
        if root.is_null() {
            let mut tmp: *mut Cell = mkCell();
            (*tmp).name = myMalloc(
                (5 as std::os::raw::c_int as std::os::raw::c_ulong).wrapping_add(strlen(name))
                    as Int32,
            ) as *mut Char;
...
extern "C" fn addFlagsFromEnvVar(mut argList: *mut *mut Cell, mut varName: *mut Char) {
    unsafe {
        let mut i: Int32 = 0;
        let mut j: Int32 = 0;
        let mut k: Int32 = 0;
...
fn main_0(mut argc: IntNative, mut argv: *mut *mut Char) -> IntNative {
    unsafe {
        let mut i: Int32 = 0;
        let mut j: Int32 = 0;
