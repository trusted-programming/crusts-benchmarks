...
#[inline]
#[linkage = "external"]
pub extern "C" fn isdigit(mut _c: std::os::raw::c_int) -> std::os::raw::c_int {
    return __isctype(_c, 0x400 as std::os::raw::c_long as std::os::raw::c_ulong);
}

#[no_mangle]
pub extern "C" fn BZ2_bz__AssertH__fail(mut errcode: std::os::raw::c_int) {
    unsafe {
        fprintf (__stderrp,
b"\n\nbzip2/libbzip2: internal error number %d.\nThis is a bug in bzip2/libbzip2, %s.\nPlease report it to: bzip2-devel@sourceware.org.  If this happened\nwhen you were using some program which uses libbzip2 as a\ncomponent, you should also report this bug to the author(s)\nof that program.  Please make an effort to report this bug;\ntimely and accurate bug reports eventually lead to higher\nquality software.  Thanks.\n\n\x00"
         as * const u8 as * const std :: os :: raw :: c_char, errcode, BZ2_bzlibVersion ());
...
extern "C" fn isempty_RL(mut s: *mut EState) -> Bool {
    unsafe {
...
pub extern "C" fn BZ2_bzCompressInit(
    ...
    unsafe {
        ...
        s = (*strm).bzalloc.expect("non-null function pointer")(
            (*strm).opaque,
            ::std::mem::size_of::<EState>() as std::os::raw::c_ulong as std::os::raw::c_int,
...
extern "C" fn copy_input_until_stop(mut s: *mut EState) -> Bool {
    unsafe {
...
extern "C" fn copy_output_until_stop(mut s: *mut EState) -> Bool {
    unsafe {
...
extern "C" fn handle_compress(mut strm: *mut bz_stream) -> Bool {
    unsafe {
        let mut progress_in: Bool = 0 as std::os::raw::c_int as Bool;
        let mut progress_out: Bool = 0 as std::os::raw::c_int as Bool;
        ...
        while 1 as std::os::raw::c_int as Bool != 0 {
            ...
            progress_in = (progress_in as std::os::raw::c_int
                | copy_input_until_stop(s) as std::os::raw::c_int)
                as Bool;
            if (*s).mode != 2 as std::os::raw::c_int
                && (*s).avail_in_expect == 0 as std::os::raw::c_int as std::os::raw::c_uint
            {
...
#[no_mangle]
pub extern "C" fn BZ2_bzCompressEnd(mut strm: *mut bz_stream) -> std::os::raw::c_int {
    unsafe {
        let mut s: *mut EState = 0 as *mut EState;
        if strm.is_null() {
            return -(2 as std::os::raw::c_int);
...
extern "C" fn unRLE_obuf_to_output_FAST(mut s: *mut DState) -> Bool {
    unsafe {
...
#[inline]
#[linkage = "external"]
pub extern "C" fn BZ2_indexIntoF(mut indx: Int32, mut cftab: *mut Int32) -> Int32 {
    unsafe {
        let mut nb: Int32 = 0;
        let mut na: Int32 = 0;
        let mut mid: Int32 = 0;
...
extern "C" fn unRLE_obuf_to_output_SMALL(mut s: *mut DState) -> Bool {
    unsafe {
        let mut k1: UChar = 0;
        if (*s).blockRandomised != 0 {
            while 1 as std::os::raw::c_int as Bool != 0 {
...
#[no_mangle]
pub extern "C" fn BZ2_bzDecompress(mut strm: *mut bz_stream) -> std::os::raw::c_int {
    unsafe {
...
#[no_mangle]
pub extern "C" fn BZ2_bzDecompressEnd(mut strm: *mut bz_stream) -> std::os::raw::c_int {
    unsafe {
        let mut s: *mut DState = 0 as *mut DState;
        if strm.is_null() {
            return -(2 as std::os::raw::c_int);
...
extern "C" fn bzopen_or_bzdopen(
    ...
    unsafe {
        ...
        let mut mode2: [std::os::raw::c_char; 10] =
            *::std::mem::transmute::<&[u8; 10], &mut [std::os::raw::c_char; 10]>(
...
#[no_mangle]
pub extern "C" fn BZ2_bzflush(mut b: *mut std::os::raw::c_void) -> std::os::raw::c_int {
    unsafe {
        return 0;
    }
}
