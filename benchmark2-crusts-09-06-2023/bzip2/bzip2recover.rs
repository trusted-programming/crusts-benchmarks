...
extern "C" fn mallocFail(mut n: Int32) {
    unsafe {
        fprintf(
            __stderrp,
...
extern "C" fn tooManyBlocks(mut max_handled_blocks: Int32) {
    unsafe {
        fprintf(
            __stderrp,
...
extern "C" fn bsPutBit(mut bs: *mut BitStream, mut bit: Int32) {
    unsafe {
...
extern "C" fn bsGetBit(mut bs: *mut BitStream) -> Int32 {
    unsafe {
...
extern "C" fn bsPutUChar(mut bs: *mut BitStream, mut c: UChar) {
    unsafe {
        let mut i: Int32 = 0;
...
extern "C" fn bsPutUInt32(mut bs: *mut BitStream, mut c: UInt32) {
    unsafe {
        let mut i: Int32 = 0;
...
extern "C" fn endsInBz2(mut name: *mut Char) -> Bool {
    unsafe {
...
fn main_0(mut argc: Int32, mut argv: *mut *mut Char) -> Int32 {
    unsafe {
