...
#[no_mangle]
pub extern "C" fn BZ2_decompress(mut s: *mut DState) -> Int32 {
    unsafe {
                            ...
                            if (*s).smallDecompress != 0 {
                                (*s).ll16 = (*strm).bzalloc.expect("non-null function pointer")(
                                    ...
                                    (((*s).blockSize100k * 100000 as std::os::raw::c_int)
                                        ...
                                        .wrapping_mul(::std::mem::size_of::<UInt16>()
                                            as std::os::raw::c_ulong)
                                        as std::os::raw::c_int,
                                    1 as std::os::raw::c_int,
                                ) as *mut UInt16;
                                ...
                                || nextSym == 1 as std::os::raw::c_int
                            {
                                ...
                                if nn < 16 as std::os::raw::c_int as std::os::raw::c_uint {
                                    ...
                                    while nn > 0 as std::os::raw::c_int as std::os::raw::c_uint {
                                        (*s).mtfa[(pp as std::os::raw::c_uint).wrapping_add(nn)
                                            as usize] = (*s).mtfa[(pp as std::os::raw::c_uint)
                                            .wrapping_add(nn)
                                            .wrapping_sub(
                                    ...
                                    (*s).mtfa[(*s).mtfbase[0 as std::os::raw::c_int as usize]
                                        as usize] = uc;
                                    if (*s).mtfbase[0 as std::os::raw::c_int as usize]
                                        == 0 as std::os::raw::c_int
                                    {
                                        kk_0 =
                                            4096 as std::os::raw::c_int - 1 as std::os::raw::c_int;
                                        ii_0 = 256 as std::os::raw::c_int
                                            / 16 as std::os::raw::c_int
                                            - 1 as std::os::raw::c_int;
                                        while ii_0 >= 0 as std::os::raw::c_int {
                                            jj_0 = 16 as std::os::raw::c_int
                                                - 1 as std::os::raw::c_int;
                                ...
                                if groupPos == 0 as std::os::raw::c_int {
                                    ...
                                    if groupNo >= nSelectors {
                                        ...
                                        gLimit =
                                            &mut *(*(*s).limit.as_mut_ptr().offset(gSel as isize))
                                                .as_mut_ptr()
                            ...
                            if (*s).origPtr < 0 as std::os::raw::c_int || (*s).origPtr >= nblock {
                                ...
                                if (*s).smallDecompress != 0 {
                                    ...
                                    while i < nblock {
                                        ...
                                        *(*s).ll16.offset(i as isize) = ((*s).cftabCopy
                                            [uc as usize]
