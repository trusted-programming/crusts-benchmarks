...
#[no_mangle]
pub extern "C" fn ti_linreg_start(
...
pub extern "C" fn ti_linreg(
    ...
    unsafe {
        ...
        if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as isize))
            ...
            == (size - ti_linreg_start(options)) as std::os::raw::c_long)
            ...
            != 0
        {
            __assert_rtn(
                ...
                .as_ptr(),
                b"indicators/linreg.c\x00" as *const u8 as *const std::os::raw::c_char,
                43 as std::os::raw::c_int,
                b"output - outputs[0] == size - ti_linreg_start(options)\x00" as *const u8
