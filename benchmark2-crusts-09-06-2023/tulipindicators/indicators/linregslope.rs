...
#[no_mangle]
pub extern "C" fn ti_linregslope_start(
...
#[no_mangle]
pub extern "C" fn ti_linregslope(
    ...
    unsafe {
        ...
        if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as isize))
            ...
            == (size - ti_linregslope_start(options)) as std::os::raw::c_long)
            as std::os::raw::c_int as std::os::raw::c_long
            != 0
        {
            __assert_rtn(
                (*::std::mem::transmute::<&[u8; 15], &[std::os::raw::c_char; 15]>(
                    b"ti_linregslope\x00",
                ))
                .as_ptr(),
                b"indicators/linregslope.c\x00" as *const u8 as *const std::os::raw::c_char,
                51 as std::os::raw::c_int,
                b"output - outputs[0] == size - ti_linregslope_start(options)\x00" as *const u8
