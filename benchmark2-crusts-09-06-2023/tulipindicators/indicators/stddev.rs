...
#[no_mangle]
pub extern "C" fn ti_stddev_start(
    ...
    unsafe {
        ...
        *fresh0 = s2s2;
        ...
        if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as isize))
            ...
            == (size - ti_stddev_start(options)) as std::os::raw::c_long)
            ...
            != 0
        {
            __assert_rtn(
                ...
                .as_ptr(),
                b"indicators/stddev.c\x00" as *const u8 as *const std::os::raw::c_char,
                68 as std::os::raw::c_int,
                b"output - outputs[0] == size - ti_stddev_start(options)\x00" as *const u8
