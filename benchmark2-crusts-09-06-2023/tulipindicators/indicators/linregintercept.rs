...
#[no_mangle]
pub extern "C" fn ti_linregintercept_start(
...
#[no_mangle]
pub extern "C" fn ti_linregintercept(
    ...
    unsafe {
        ...
        if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as isize))
            ...
            == (size - ti_linregintercept_start(options)) as std::os::raw::c_long)
            as std::os::raw::c_int as std::os::raw::c_long
            != 0
        {
            __assert_rtn(
                (*::std::mem::transmute::<&[u8; 19], &[std::os::raw::c_char; 19]>(
                    b"ti_linregintercept\x00",
                ))
                .as_ptr(),
                b"indicators/linregintercept.c\x00" as *const u8 as *const std::os::raw::c_char,
                43 as std::os::raw::c_int,
                b"output - outputs[0] == size - ti_linregintercept_start(options)\x00" as *const u8
