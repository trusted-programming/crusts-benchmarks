...
#[no_mangle]
pub extern "C" fn ti_wilders_start(
    ...
    unsafe {
        ...
        *fresh0 = val;
        ...
        if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as isize))
            ...
            == (size - ti_wilders_start(options)) as std::os::raw::c_long)
            ...
            != 0
        {
            __assert_rtn(
                ...
                .as_ptr(),
                b"indicators/wilders.c\x00" as *const u8 as *const std::os::raw::c_char,
                60 as std::os::raw::c_int,
                b"output - outputs[0] == size - ti_wilders_start(options)\x00" as *const u8
