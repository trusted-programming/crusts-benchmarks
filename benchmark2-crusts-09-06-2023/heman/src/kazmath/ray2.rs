...
#[no_mangle]
pub extern "C" fn kmRay2FillWithEndpoints(
    mut ray: *mut kmRay2,
...
#[no_mangle]
pub extern "C" fn kmLine2WithLineIntersection(
    ...
    unsafe {
        ...
        if denom as f64 > -0.0001f64 && (denom as f64) < 0.0001f64 {
            return 0;
        }
...
#[no_mangle]
pub extern "C" fn kmSegment2WithSegmentIntersection(
...
#[no_mangle]
pub extern "C" fn kmRay2IntersectLineSegment(
...
#[no_mangle]
pub extern "C" fn calculate_line_normal(
    mut p1: kmVec2,
    mut p2: kmVec2,
...
#[no_mangle]
pub extern "C" fn kmRay2IntersectTriangle(
    mut ray: *const kmRay2,
    mut p1: *const kmVec2,
    mut p2: *const kmVec2,
    mut p3: *const kmVec2,
    ...
    unsafe {
        ...
        if kmRay2IntersectLineSegment(ray, p2, p3, &mut intersect) != 0 {
            ...
            let mut this_distance_0 =
                kmVec2Length(kmVec2Subtract(&mut tmp_0, &mut intersect, &(*ray).start));
            let mut this_normal_0 = kmVec2 { x: 0., y: 0. };
            calculate_line_normal(*p2, *p3, *p1, &mut this_normal_0);
            if this_distance_0 < distance && kmVec2Dot(&mut this_normal_0, &(*ray).dir) < 0.0f32 {
                final_intersect.x = intersect.x;
                final_intersect.y = intersect.y;
        ...
        if kmRay2IntersectLineSegment(ray, p3, p1, &mut intersect) != 0 {
            ...
            let mut this_distance_1 =
                kmVec2Length(kmVec2Subtract(&mut tmp_1, &mut intersect, &(*ray).start));
            let mut this_normal_1 = kmVec2 { x: 0., y: 0. };
            calculate_line_normal(*p3, *p1, *p2, &mut this_normal_1);
            if this_distance_1 < distance && kmVec2Dot(&mut this_normal_1, &(*ray).dir) < 0.0f32 {
                final_intersect.x = intersect.x;
                final_intersect.y = intersect.y;
...
#[no_mangle]
pub extern "C" fn kmRay2IntersectBox(
    mut ray: *const kmRay2,
    mut p1: *const kmVec2,
    mut p2: *const kmVec2,
    mut p3: *const kmVec2,
    ...
    unsafe {
        ...
        while i < 4 {
            ...
            let mut next_point = if i == 3 {
                points[0 as usize]
            } else {
                points[i.wrapping_add(1) as usize]
            };
            let mut other_point = if i == 3 || i == 0 {
                points[1 as usize]
            } else {
                points[0 as usize]
            };
...
#[no_mangle]
pub extern "C" fn kmRay2IntersectCircle(
    mut ray: *const kmRay2,
    centre: kmVec2,
    radius: libc::c_float,
    mut intersection: *mut kmVec2,
    ...
    unsafe {
        if 0 != 0 && !(b"Not implemented\0" as *const u8 as *const i8).is_null() {
            ...
            __assert_fail (b"0 && \"Not implemented\"\0" as * const u8 as * const i8, b"../kazmath/ray2.c\0" as * const u8 as * const i8, 256, (* :: std :: mem :: transmute :: < & [u8; 89], & [i8; 89], > (
              b"unsigned char kmRay2IntersectCircle(const kmRay2 *, const kmVec2, const float, kmVec2 *)\0",)).as_ptr (),);
        }
        return 1;
    }
}
