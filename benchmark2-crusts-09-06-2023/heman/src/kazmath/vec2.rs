...
#[no_mangle]
pub extern "C" fn kmVec2Length(mut pIn: *const kmVec2) -> libc::c_float {
    unsafe {
...
#[no_mangle]
pub extern "C" fn kmVec2LengthSq(mut pIn: *const kmVec2) -> libc::c_float {
    unsafe {
...
#[no_mangle]
pub extern "C" fn kmVec2Normalize(mut pOut: *mut kmVec2, mut pIn: *const kmVec2) -> *mut kmVec2 {
    unsafe {
        if (*pIn).x == 0. && (*pIn).y == 0. {
...
#[no_mangle]
pub extern "C" fn kmVec2Dot(mut pV1: *const kmVec2, mut pV2: *const kmVec2) -> libc::c_float {
    unsafe {
...
#[no_mangle]
pub extern "C" fn kmVec2Cross(mut pV1: *const kmVec2, mut pV2: *const kmVec2) -> libc::c_float {
    unsafe {
...
#[no_mangle]
pub extern "C" fn kmVec2Subtract(
    mut pOut: *mut kmVec2,
    mut pV1: *const kmVec2,
    mut pV2: *const kmVec2,
) -> *mut kmVec2 {
...
#[no_mangle]
pub extern "C" fn kmVec2Transform(
    mut pOut: *mut kmVec2,
    mut pV: *const kmVec2,
    mut pM: *const kmMat3,
) -> *mut kmVec2 {
...
#[no_mangle]
pub extern "C" fn kmVec2TransformCoord(
    mut pOut: *mut kmVec2,
    mut pV: *const kmVec2,
    mut pM: *const kmMat3,
) -> *mut kmVec2 {
    unsafe {
        __assert_fail(
            ...
            b"../kazmath/vec2.c\0" as *const u8 as *const i8,
            134,
...
#[no_mangle]
pub extern "C" fn kmVec2AreEqual(mut p1: *const kmVec2, mut p2: *const kmVec2) -> i32 {
    unsafe {
        return (((*p1).x as f64) < (*p2).x as f64 + 0.0001f64
            && (*p1).x as f64 > (*p2).x as f64 - 0.0001f64
            && (((*p1).y as f64) < (*p2).y as f64 + 0.0001f64
                && (*p1).y as f64 > (*p2).y as f64 - 0.0001f64)) as i32;
    }
}

#[no_mangle]
pub extern "C" fn kmVec2Assign(mut pOut: *mut kmVec2, mut pIn: *const kmVec2) -> *mut kmVec2 {
    unsafe {
...
#[no_mangle]
pub extern "C" fn kmVec2RotateBy(
    mut pOut: *mut kmVec2,
    mut pIn: *const kmVec2,
...
#[no_mangle]
pub extern "C" fn kmVec2DegreesBetween(
    mut v1: *const kmVec2,
    mut v2: *const kmVec2,
) -> libc::c_float {
    unsafe {
        ...
        if dot as f64 > 1.0f64 {
            dot = 1.0f64 as libc::c_float;
        }
        if (dot as f64) < -1.0f64 {
            dot = -1.0f64 as libc::c_float;
        }
        return kmRadiansToDegrees(atan2(cross as f64, dot as f64) as libc::c_float);
    }
}

#[no_mangle]
pub extern "C" fn kmVec2DistanceBetween(
    mut v1: *const kmVec2,
    mut v2: *const kmVec2,
) -> libc::c_float {
    unsafe {
        ...
        return fabs(kmVec2Length(&mut diff) as f64) as libc::c_float;
    }
}

#[no_mangle]
pub extern "C" fn kmVec2MidPointBetween(
    mut pOut: *mut kmVec2,
    mut v1: *const kmVec2,
    mut v2: *const kmVec2,
) -> *mut kmVec2 {
